...
//
//        var task = this.repository.save(new HierarchicalClusteringTask(1L, BigDecimal.TWO, TaskStatus.APPROVED, 5));
//        this.taskId = task.getId();
//
//        var submission = new HierarchicalClusteringSubmission("test-user", "test-id", task, "de", 3, SubmissionMode.SUBMIT, "5");
...
//        this.ungraded = this.submissionRepository.save(new HierarchicalClusteringSubmission("test-user", "test-id", task, "de", 3, SubmissionMode.SUBMIT, "5")).getId();
//    }
//
//    //#region --- SUBMIT ---
//    @Test
...
//            .contentType(ContentType.JSON)
//            .body(new SubmitSubmissionDto<>("test-user", "test-id", this.taskId, "de", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("5")))
//            // WHEN
//            .when()
//            .post("/api/submission")
//            // THEN
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.SUBMIT_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new SubmitSubmissionDto<>("test-user", "test-id", this.taskId, "it", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("5")))
//            // WHEN
//            .when()
//            .post("/api/submission")
//            // THEN
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.SUBMIT_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new SubmitSubmissionDto<>("test-user", "test-id", this.taskId + 1, "de", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("5")))
//            // WHEN
//            .when()
//            .post("/api/submission")
//            // THEN
...
//                    .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.SUBMIT_API_KEY)
//                    .contentType(ContentType.JSON)
//                    .body(new SubmitSubmissionDto<>("test-user-" + i, "test-id", this.taskId, "de", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("5")))
//                    // WHEN
//                    .when()
//                    .post("/api/submission")
//                    // THEN
