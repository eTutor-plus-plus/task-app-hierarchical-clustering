package at.jku.dke.task_app.hierarchical_clustering;
...
class AppPostgresContainer extends PostgreSQLContainer<AppPostgresContainer> {
    ...
    public static final String USERNAME = "etutor_hierarchical_clustering_test_admin";
    public static final String PASSWORD = "strong-password";
    public static final String ETUTOR_USERNAME = "etutor_hierarchical_clustering_test";
    public static final String ETUTOR_PASSWORD = "etutor_hierarchical_clustering_pwd";
