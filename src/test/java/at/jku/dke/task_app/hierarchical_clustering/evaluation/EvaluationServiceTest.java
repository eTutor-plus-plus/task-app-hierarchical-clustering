...
//        var task = taskRepository.save(new HierarchicalClusteringTask(1L, BigDecimal.TEN, TaskStatus.APPROVED, taskGroup, 20));
...
//    void evaluateRun() {
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.RUN, 3, new HierarchicalClusteringSubmissionDto("20"));
//
//        // Act
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("20"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("20 jku"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.SUBMIT, 3, new HierarchicalClusteringSubmissionDto("18"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.DIAGNOSE, 3, new HierarchicalClusteringSubmissionDto("20"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.DIAGNOSE, 3, new HierarchicalClusteringSubmissionDto("20 test"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.DIAGNOSE, 3, new HierarchicalClusteringSubmissionDto("25"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.DIAGNOSE, 3, new HierarchicalClusteringSubmissionDto("15"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
...
//        // Arrange
//        SubmitSubmissionDto<HierarchicalClusteringSubmissionDto> dto = new SubmitSubmissionDto<>("test-user", "test-assignment", taskId,
//            "en", SubmissionMode.DIAGNOSE, 0, new HierarchicalClusteringSubmissionDto("15"));
//
//        // Act
//        var result = evaluationService.evaluate(dto);
//
