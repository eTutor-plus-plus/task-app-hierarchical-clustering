...
class BinarySearchTaskGroupServiceTest {
    ...
    void createTaskGroup() {
        // Arrange
        ModifyTaskGroupDto<ModifyBinarySearchTaskGroupDto> dto = new ModifyTaskGroupDto<>("hierarchical-clustering", TaskStatus.APPROVED, new ModifyBinarySearchTaskGroupDto(1, 2));
