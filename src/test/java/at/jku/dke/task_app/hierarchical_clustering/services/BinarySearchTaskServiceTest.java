...
class BinarySearchTaskServiceTest {
    ...
    void createTask() {
        // Arrange
        ModifyTaskDto<ModifyBinarySearchTaskDto> dto = new ModifyTaskDto<>(7L, BigDecimal.TEN, "hierarchical-clustering", TaskStatus.APPROVED, new ModifyBinarySearchTaskDto(33));
