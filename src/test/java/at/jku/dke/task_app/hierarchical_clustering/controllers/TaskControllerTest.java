...
//        this.taskId = this.repository.save(new HierarchicalClusteringTask(1L, BigDecimal.TWO, TaskStatus.APPROVED, group, 5)).getId();
//    }
//
//    //#region --- GET ---
//    @Test
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "hierarchical-clustering", TaskStatus.APPROVED, new ModifyHierarchicalClusteringTaskDto(6)))
//            // WHEN
//            .when()
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "", TaskStatus.APPROVED, new ModifyHierarchicalClusteringTaskDto(6)))
//            // WHEN
//            .when()
//            .post("/api/task/{id}", this.taskId + 2)
//            // THEN
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "hierarchical-clustering", TaskStatus.APPROVED, new ModifyHierarchicalClusteringTaskDto(9)))
//            // WHEN
//            .when()
...
//            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
//            .contentType(ContentType.JSON)
//            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "sql", TaskStatus.APPROVED, new ModifyHierarchicalClusteringTaskDto(9)))
//            // WHEN
//            .when()
//            .put("/api/task/{id}", this.taskId)
//            // THEN
...
//    void mapToDto() {
//        // Arrange
//        var task = new HierarchicalClusteringTask(42);
//
//        // Act
