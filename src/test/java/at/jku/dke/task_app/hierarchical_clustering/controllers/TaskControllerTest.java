...
class TaskControllerTest {
    ...
    void createShouldReturnCreated() {
        given()
            ...
            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
            .contentType(ContentType.JSON)
            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "hierarchical-clustering", TaskStatus.APPROVED, new ModifyBinarySearchTaskDto(6)))
            // WHEN
            .when()
    ...
    void updateShouldReturnOk() {
        given()
            ...
            .header(AuthConstants.AUTH_TOKEN_HEADER_NAME, ClientSetupExtension.CRUD_API_KEY)
            .contentType(ContentType.JSON)
            .body(new ModifyTaskDto<>(this.taskGroupId, BigDecimal.TEN, "hierarchical-clustering", TaskStatus.APPROVED, new ModifyBinarySearchTaskDto(9)))
            // WHEN
            .when()
